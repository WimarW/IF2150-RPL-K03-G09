...
| ID KF | ID Kebutuhan | Penjelasan (EARS) |
| :--- | :--- | :--- |
| KF-01 |  | Sistem harus menyediakan form unggah kebutuhan jasa yang memungkinkan pelanggan mengisi deskripsi pekerjaan, kategori jasa, dan lokasi. |
| KF-02 |  | Sistem harus memvalidasi bahwa kategori jasa yang diunggah termasuk dalam sektor informal; jika kategori tidak valid, sistem harus menolak unggahan dan menampilkan pesan kesalahan. |
| KF-03 |  | Ketika pelanggan mengirimkan form kebutuhan jasa, sistem harus menyimpan data tersebut ke dalam basis data dan menampilkan konfirmasi keberhasilan kepada pelanggan. |
| KF-04 |  | Sistem harus menyediakan halaman pendaftaran bagi pemberi jasa yang mencakup data diri, jenis jasa yang ditawarkan, dan nomor rekening aktif. |
...
| KF-15 |  | Ketika pembayaran berhasil dilakukan, sistem harus memperbarui status pesanan secara otomatis dan mencatat riwayat transaksi (waktu, nominal, pihak terlibat) ke dalam basis data. |
