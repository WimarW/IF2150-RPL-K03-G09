...
| No | Aksi Aktor | Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- | :--- |
...
| 2 | *Pelanggan mengunggah formulir pendaftaran jasa* | *Pelanggan* | *Sistem memverifikasi data yang dikirimkan dan memperbarui data pemberi jasa* |
...
| :--- | :--- | :--- | :--- |
| 1 | *Pemberi jasa menekan tombol daftar jasa dan mengisi formulir* | *Pemberi jasa* | *Sistem menampilkan formulir untuk mendaftarkan jasa* |
| 2 | *Pemberi jasa mengunggah formulir pendaftaran jasa* | *Pemberi jasa* | *Sistem memverifikasi data yang dikirimkan dan menerima verifikasi gagal* |
| 3 | *Pemberi jasa mengisi formulir ulang* | *Pemberi jasa* | *(1) Sistem menandai field atau jawaban yang salah, (2) sistem memberi error message pada field tersebut, (3) sistem kembali kepada field tersebut* |
