...
| C17 | KontrakPekerjaanController | Menjebatani KontrakPekerjaanUI, database, dan KontrakPekerjaan(status) | UC07 |
| C18 | KontrakPekerjaanUI | Halaman Ketika Pekerjaan sudah selesai | UC07 |
| C19 | TiketLaporanController | Menghubungkan TiketLaporanUI, Database, notifikasi | UC08, UC09 |
| C20 | TiketLaporanUI | Tampilan dari laman form TiketLaporan | UC08, UC09 |
| *...* | *...* | *...* | *...* |
