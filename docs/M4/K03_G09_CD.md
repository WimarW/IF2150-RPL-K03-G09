...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C01 | Pengguna | idPengguna, email, noTelpon, password, akumulasiRating | +beriRating()<br>+bisaSubmitRatinh()<br>+tambahRatingKeRiwayat()<br>+ambilRiwayatRating()<br>+sudahMemberiRating() |
