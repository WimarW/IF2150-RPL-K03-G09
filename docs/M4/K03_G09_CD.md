...
| C10 | Rating | Merealisasikan fitur rating untuk PemberiJasa dan Pelanggan, berupa skor skala 5 dan ulasan singkat | UC08, UC09 |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C01 | Pengguna | idPengguna, email, noTelpon, password, akumulasiRating | beriRating(), lihatRating() |
| C02 | PemberiJasa | idPengguna, email, noTelpon, password, akumulasiRating | beriRating(), lihatRating() |
| C03 | Pelanggan | idPengguna, email, noTelpon, password, akumulasiRating | beriRating(), lihatRating() |
