...
| C05 | KategoriJasa | Menyimpan data mengenai kategori-kategori jasa sektor informal, seperti sol sepatu | UC01, UC02 |
| C06 | LayananJasa | Menyimpan data spesifik jasa yang ditawarkan oleh PemberiJasa | UC01, UC02 |
| C07 | Pekerjaan | Menyimpan data detail kesepakatan antara Pelanggan dan PemberiJasa, seperti harga, detail pekerjaan, status pekerjaan (On Progress/Done) | UC05, UC06, UC07, UC10 |
| C08 | LamanKomunikasi | Merealisasikan fitur chat langsung antara Pelanggan, PemberiJasa, ataupun LayananPelanggan | UC03, UC04, UC09|
| C09 | TiketLaporan | Merealisasikan fitur tiket antrian dari laporan yang diberikan Pelanggan dan PemberiJasa | UC08, UC09|
| C10 | Rating | Merealisasikan fitur rating untuk PemberiJasa dan Pelanggan, berupa skor skala 5 dan ulasan singkat | UC10 |
| C11 | Notifikasi | Merealisasikan fitur notifikasi yang akan diberikan kepada PemberiJasa ketika jasanya dipesan | UC08, UC09 |
| C12 | RatingUI | Merealisasikan halaman pengisian rating setelah pekerjaan selesai | UC10 |
| C13 | RatingController | Menjembatani RatingUI dengan database  | UC10 |
| C14 | Database | Tempat penyimpnan data perangkat lunak  | XXXXX |
| *...* | *...* | *...* | *...* |
...
| *C05* | *KategoriJasa* | *Menyimpan data mengenai kategori-kategori jasa sektor informal, seperti sol sepatu* |
| *C06* | *LayananJasa* | *Menyimpan data spesifik jasa yang ditawarkan oleh PemberiJasa* |
...
| *C02* | *PemberiJasa* | *idPengguna, nama, usia, tipeJasa, rating, tersedia, deskripsi, lokasi, email, noTelp, password* | *ubahDataPemberiJasa()* |
| *C05* | *KategoriJasa* | *daftarJasa, jumlahPemberiJasaTersedia* | *tambahDaftarJasa(), hapusDaftarJasa(), cekDaftarJasa(), tampilkanDaftarJasa()* |
| *C06* | *LayananJasa* | *hargaJasa, waktuPengerjaan, deskripsi, radiusPelangganDiterima* | *ubahDataLayananJasa()* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C02* | *PemberiJasa* | *idPengguna, nama, usia, tipeJasa, rating, tersedia, deskripsi, lokasi* | *ubahDataPemberiJasa()* |
| *C03* | *Pelanggan* | *idPengguna, nama, usia, rating, lokasi, email, noTelpon, password* | *ubahDataPelanggan()* |
| *C05* | *KategoriJasa* | *daftarJasa, jumlahPemberiJasaTersedia* | *tambahDaftarJasa(), hapusDaftarJasa(), cekDaftarJasa(), tampilkanDaftarJasa()* |
| *C06* | *LayananJasa* | *hargaJasa, waktuPengerjaan, deskripsi, radiusPelangganDiterima* | *ubahDataLayananJasa()* |
...
| :--- | :--- | :--- |
| *C03* | *Pelanggan* | *Turunan dari kelas Pengguna yang bertanggung jawab dalam proses pemesanan jasa, memasukkan input kesepakatan harga dan pekerjaan dan mengonfirmasi selesainya pekerjaan, melaporkan masalah, dan memberikan rating kepada pemberi jasa. Selain itu, menyimpan data akumulasi rating dan data Pelanggan* |
| *C08* | *LamanKomunikasi* | *Merealisasikan fitur chat langsung antara Pelanggan, PemberiJasa, ataupun LayananPelanggan* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C03* | *Pelanggan* | *nama, usia, rating, lokasi, email, noTelpon, password* | *ubahDataPelanggan()* |
| *C08* | *LamanKomunikasi* | *idChat, idPengguna, statusChat, waktuChatDikirim* | *kirimPesan(), tandaiDikirim(), tandaiDibaca(), ubahStatus()* |
...
#### Diagram Kelas
<p align="center">
<img alt="Class Diagram UC10" src="./" width="70%">
</p>
<p align="center">
<i>Gambar X. Diagram Kelas Use Case UC10</i>
</p>
...
| :--- | :--- | :--- |
| C03 | Pelanggan | Turunan dari kelas Pengguna yang bertanggung jawab dalam proses pemesanan jasa, memasukkan input kesepakatan harga dan pekerjaan dan mengonfirmasi selesainya pekerjaan, melaporkan masalah, dan memberikan rating kepada pemberi jasa. Selain itu, menyimpan data akumulasi rating dan data Pelanggan |
| C07 | Pekerjaan | Menyimpan data detail kesepakatan antara Pelanggan dan PemberiJasa, seperti harga, detail pekerjaan, status pekerjaan (On Progress/Done)|
...
| C02 | PemberiJasa | Turunan dari kelas Pengguna yang bertanggung jawab dalam proses pekerjaan, memberi rating, memberi laporan kepada layanan pelanggan. Menyimpan titik lokasi, akumulasi rating, identitas pemberi jasa, deskripsi keahlian |
| C03 | Pelanggan | Turunan dari kelas Pengguna yang bertanggung jawab dalam proses pemesanan jasa, memasukkan input kesepakatan harga dan pekerjaan dan mengonfirmasi selesainya pekerjaan, melaporkan masalah, dan memberikan rating kepada pemberi jasa. Selain itu, menyimpan data akumulasi rating dan data Pelanggan |
| C09 | TiketLaporan | Merealisasikan fitur tiket antrian dari laporan yang diberikan Pelanggan dan PemberiJasa |
...
| C02 | PemberiJasa | Turunan dari kelas Pengguna yang bertanggung jawab dalam proses pekerjaan, memberi rating, memberi laporan kepada layanan pelanggan. Menyimpan titik lokasi, akumulasi rating, identitas pemberi jasa, deskripsi keahlian |
| C03 | Pelanggan | Turunan dari kelas Pengguna yang bertanggung jawab dalam proses pemesanan jasa, memasukkan input kesepakatan harga dan pekerjaan dan mengonfirmasi selesainya pekerjaan, melaporkan masalah, dan memberikan rating kepada pemberi jasa. Selain itu, menyimpan data akumulasi rating dan data Pelanggan |
| C10 | Rating | Merealisasikan fitur rating untuk PemberiJasa dan Pelanggan, berupa skor skala 5 dan ulasan singkat |
| C12 | RatingUI | Merealisasikan halaman pengisian rating setelah pekerjaan selesai |
| C13 | RatingController | Menjembatani RatingUI dengan database  |
| C14 | Database | Tempat penyimpnan data perangkat lunak  |


#### Diagram Kelas
<p align="center">
<img alt="Class Diagram UC10" src="./assets/diagram/Diagram-kelas-UC10.png" width="70%">
</p>
<p align="center">
<i>Gambar X. Diagram Kelas Use Case UC10</i>
</p>
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C01 | Pengguna | idPengguna, email, noTelpon, password, akumulasiRating | +canSubmitRating()<br>+addRatingToHistory()<br>+getRatingHistory()<br>+hasRatedTarget() |
| C02 | PemberiJasa | jenisJasa | - |
| C03 | Pelanggan | - | - |
| C10 | Rating | idTugas, pemberiRating, penerimaRating, angkaRating | - |
| C12 | RatingUI | targetId, ratingScore | +selectRating() +submitRating()<br>+showSuccess()<br>+showError()<br>+close() |
| C13 | RatingController | userId, databaseHandler | +processRating() <br>-validateInput() <br>-hasRated() <br>-createRating() <br>-saveToDatabase()
| C14 | Database | - | saveRating() | 
...
<p align="center">
<i>Gambar X. Diagram Kelas Use Case UC11</i>
</p>

| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C01 | Pengguna | idPengguna, email, noTelpon, password, akumulasiRating | masukAkun() |
| C02 | PemberiJasa | idPengguna, email, noTelpon, password, akumulasiRating | masukAkun() |
| C03 | Pelanggan | idPengguna, email, noTelpon, password, akumulasiRating | masukAkun() |
| C04 | LayananPelanggan | idLayananPelanggan, password | masukAkun() |
