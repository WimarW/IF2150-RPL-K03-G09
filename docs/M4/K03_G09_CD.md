...
| *C05* | *LayananJasa* | *Menyimpan data spesifik jasa yang ditawarkan oleh PemberiJasa* |
...
| *C06* | *LayananJasa* | *hargaJasa, waktuPengerjaan, deskripsi, radiusPelangganDiterima* | *getListJasa()* |
...
| *C08* | *LamanKomunikasi* | *idChat, idPengguna, statusChat, waktuTerkirim, isChatTerbaca, durasiChat* | *+kirimPesan()<br>lihatPesan()<br>+ubahStatus()<br>+bukaTutupChat()<br>+tampilkanPesan()* |
