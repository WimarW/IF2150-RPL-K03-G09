...
| C05 | LayananJasa | Menyimpan data spesifik jasa yang ditawarkan oleh PemberiJasa | UC01, UC02 |
...
| C07 | LamanKomunikasi | Merealisasikan fitur chat langsung antara Pelanggan, PemberiJasa, ataupun LayananPelanggan | UC03, UC04, UC09|
...
| C10 | Notifikasi | Merealisasikan fitur notifikasi yang akan diberikan kepada PemberiJasa ketika jasanya dipesan | UC08, UC09 |
...
| C13 | Database | Tempat penyimpnan data perangkat lunak  | XXXXX |
| *...* | *...* | *...* | *...* |
...
#### Diagram Kelas
<p align="center">
<img alt="Class Diagram UC10" src="./assets/diagram/Diagram-kelas-UC10.png" width="60%">
</p>
<p align="center">
<i>Gambar X. Diagram Kelas Use Case UC10</i>
</p>
...
| C11 | RatingUI | targetId, ratingScore | +selectRating() +submitRating()<br>+showSuccess()<br>+showError()<br>+close() |
| C12 | RatingController | userId, databaseHandler | +processRating() <br>-validateInput() <br>-hasRated() <br>-createRating() <br>-saveToDatabase()
| C13 | Database | - | saveRating() | 
