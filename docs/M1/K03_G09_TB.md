...
a. Pengguna memiliki smartphone yang dapat mengoperasikan perangkat lunak 
b. Pengguna mengunggah kebutuhan jasa yang ril (bukan fiktif atau penipuan)
c. Profil pengguna yang terdapat di aplikasi tidak bersifat fiktif
d. Pengguna memiliki koneksi internet yang aktif

### 2.2.2 Asumsi Pemilik Jasa
a. Pemilik jasa profesional dalam melakukan pekerjaannya
b. Pemilik jasa mengaktifkan GPS setiap menerima layanan jasa (jika memiliki smartphone)
c. Profil pemilik jasa yang terdapat di aplikasi tidak bersifat fiktif
d. Pemilik jasa memiliki koneksi internet yang aktif
...
a. Sistem operasi yang terbatas pada Android berdasarkan jumlah pengguna terbanyak
b. Aplikasi hanya tersedia untuk Android versi terbaru
c. Hanya mendukung sedikit bahasa (Indonesia & Inggris)
d. Skalabilitas arsitektur perangkat lunak terbatas
